...
const PROTECTED_ROUTES = {
  // User routes
  '/profile': { roles: [UserRole.CUSTOMER, UserRole.MODERATOR, UserRole.ADMIN] },
  '/orders': { roles: [UserRole.CUSTOMER, UserRole.MODERATOR, UserRole.ADMIN] },
  '/wishlist': { roles: [UserRole.CUSTOMER, UserRole.MODERATOR, UserRole.ADMIN] },
  '/cart': { roles: [UserRole.CUSTOMER, UserRole.MODERATOR, UserRole.ADMIN] },
  '/checkout': { roles: [UserRole.CUSTOMER, UserRole.MODERATOR, UserRole.ADMIN] },
