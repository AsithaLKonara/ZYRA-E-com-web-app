// Only import jest-dom for jsdom environment
...
process.env.DATABASE_URL = process.env.DATABASE_URL || 'postgresql://asithalakmal@localhost:5432/zyra_fashion?schema=public';
...
// DATABASE_URL is set in jest.env-setup.js - don't override it here
...
// Mock navigator (only in jsdom environment)
...
afterEach(() => {
  jest.clearAllMocks();
  if (typeof window !== 'undefined' && global.localStorage && global.localStorage.clear) {
    global.localStorage.clear();
  }
  if (typeof window !== 'undefined' && global.sessionStorage && global.sessionStorage.clear) {
