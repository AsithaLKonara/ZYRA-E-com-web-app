...
class DatabaseMigration {
  ...
  async applyMigrations(): Promise<{
    ...
    try {
      ...
      logger.error('Failed to apply migrations:', {}, error instanceof Error ? error : new Error(String(error)))
  ...
  async createMigration(name: string): Promise<{
    ...
    try {
      ...
      logger.error('Failed to create migration:', {}, error instanceof Error ? error : new Error(String(error)))
      return {
        success: false,
  ...
  async generateClient(): Promise<{
    ...
    try {
      ...
      logger.error('Failed to generate Prisma client:', {}, error instanceof Error ? error : new Error(String(error)))
      return {
        success: false,
        error: error instanceof Error ? error.message : 'Unknown error',
      }
  ...
  async getHistory(): Promise<{
    ...
    try {
      ...
      logger.error('Failed to get migration history:', {}, error instanceof Error ? error : new Error(String(error)))
      return { migrations: [] }
    }
  }
}
