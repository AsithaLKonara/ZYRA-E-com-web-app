...
export function sanitizeSQLInput(input: string): string {
  try {
    ...
    logger.error('Error sanitizing SQL input:', error)
    return ''
  }
}
...
export function sanitizeJSONInput(jsonString: string): any {
  try {
    ...
    logger.error('Error sanitizing JSON input:', error)
    return null
  }
}
...
export function sanitizePhone(phone: string): string {
  try {
    ...
    logger.error('Error sanitizing phone:', error)
    return ''
  }
}
...
export function containsMaliciousPatterns(input: string): boolean {
  try {
    ...
    logger.error('Error checking malicious patterns:', error)
