...
function validateEnv() {
  ...
  // This prevents validation errors when env vars are set via jest.env-setup.js
  ...
  try {
    ...
    if (error instanceof z.ZodError) {
      ...
      return envSchema.parse({
        ...
        DATABASE_URL: process.env.DATABASE_URL || (isTest ? 'postgresql://localhost:5432/test' : 'postgresql://localhost:5432/zyra_fashion'),
