...
export class FacebookAdsAPI {
  ...
  async createAdSet(request: AdSetRequest): Promise<AdSet> {
    try {
      ...
      logger.error('Failed to create Facebook ad set:', error)
      throw error
    }
  }
  ...
  async createAd(request: AdRequest): Promise<Ad> {
    try {
      ...
      logger.error('Failed to create Facebook ad:', error)
      throw error
    }
  }
  ...
  async getCampaign(campaignId: string): Promise<Campaign> {
    try {
      ...
      logger.error('Failed to get Facebook campaign:', error)
      throw error
    }
  }
  ...
  async getAdSet(adSetId: string): Promise<AdSet> {
    try {
      ...
      logger.error('Failed to get Facebook ad set:', error)
      throw error
    }
  }
  ...
  async getAd(adId: string): Promise<Ad> {
    try {
      ...
      logger.error('Failed to get Facebook ad:', error)
      throw error
    }
  }
  ...
  async boostPost(
    ...
    try {
      ...
      logger.error('Facebook boost failed:', error)
      throw error
    }
  }
  ...
  async getAdInsights(adId: string, dateRange: { since: string; until: string }) {
    try {
      ...
      logger.error('Failed to get Facebook ad insights:', error)
      throw error
    }
  }
}
...
export const facebookAdsAPI = createFacebookAdsAPI(config.meta.accessToken, config.meta.adAccountId)
