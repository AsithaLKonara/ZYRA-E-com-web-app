...
export class InstagramAPI {
  ...
  async createMediaContainer(request: InstagramPublishRequest): Promise<InstagramContainer> {
    try {
      ...
      logger.error('Failed to create Instagram media container:', error)
      throw error
    }
  }
  ...
  async getContainerStatus(containerId: string): Promise<InstagramContainer> {
    try {
      ...
      logger.error('Failed to get Instagram container status:', error)
      throw error
    }
  }
  ...
  async publishContainer(containerId: string): Promise<InstagramPublishResponse> {
    try {
      ...
      logger.error('Failed to publish Instagram container:', error)
      throw error
    }
  }
...
export const instagramAPI = createInstagramAPI(config.meta.accessToken)
